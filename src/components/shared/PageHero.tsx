        ...
        <HeroTitleWrapper>
          <div className="flex flex-col items-center">
            ...
            {subtitleLines.length > 0 ? (
              <div
                className={cn(
                  "flex flex-col items-center gap-1 py-[clamp(10px,2.5vw,16px)] text-[clamp(18px,3.1vw,31px)] font-light uppercase leading-[clamp(26.7px,4.5vw,43px)] tracking-[-0.03em] text-paper",
                  subtitleClassName
                )}
              >
